...
.no_chng:
		...
		mov	@r15+,r13
		mov	@r15+,r14
		mov	r11,r0		; r0 - next block
		shll2	r0
		shll2	r0
		shll	r0
		add	r11,r2		; Add Y count
		cmp/ge	r9,r2
		bf/s	.y_loop
		add	r0,r13
		lds	@r15+,pr
...
;
; 		mov	#RAM_Mars_RdrwBlocks,r13
; 		mov	@(mbg_xpos,r14),r1		; TODO: read cache'd pos instead
; 		mov	@(mbg_ypos,r14),r2
; 		shlr16	r1
; 		shlr16	r2
; 		exts.w	r1,r1
...
; 		mov	#_framebuffer,r12
; 		mov	@(mbg_fbdata,r14),r0
; 		add	r0,r12				; r12 - framebuffer position
