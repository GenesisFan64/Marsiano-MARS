...
.nxt_chnl:
		...
		jr	nz,.is_valid
		ld	de,1		; All this increment nonsense
		add	iy,de		; just to syncronize WAV playback
		inc	iy		; if this channel isn't being processed.
		inc	iy
		inc	iy
		rst	8
		ld	de,2
...
.is_valid:
		call	.do_chnl
		ld	de,8		; Do normal increment if a channel
		add	iy,de		; actually wants to process
		pop	bc
		djnz	.nxt_chnl
		ret
