...
trk_NoteBuff	equ 26			; Buff'd Track (100h bytes)
trk_BlkData	equ 28			; Blocks and headers data pointer
trk_HeadData	equ 30
...
insDataC	ds 200h*MAX_TRKS	; Instrument data+pointers for current track: 100h bytes
