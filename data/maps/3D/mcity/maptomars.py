...
TAG_THISFOLDER    = "data/maps/3D/mcity/" # base folder
...
out_layoutm   = open(object_name+"_incl.asm","w")
...
for curr_rdpz in range(0,num_pz):
  ...
  out_head.write('.vert:\t\tbinclude "'+TAG_THISFOLDER+'pz/'+mappz_list[curr_pz]+'_vert.bin"\n')
  out_head.write('.face:\t\tbinclude "'+TAG_THISFOLDER+'pz/'+mappz_list[curr_pz]+'_face.bin"\n')
  out_head.write('.vrtx:\t\tbinclude "'+TAG_THISFOLDER+'pz/'+mappz_list[curr_pz]+'_vrtx.bin"\n')
  out_head.write('.mtrl:\t\tinclude "'+TAG_THISFOLDER+'pz/'+mappz_list[curr_pz]+'_mtrl.asm"\n')
...
out_layout.write('\t\tbinclude "'+TAG_THISFOLDER+object_name+'_lay.bin"\n\t\talign 4\n')
...
for i in range(0,len(mappz_list)):
	a = mappz_list[i]
	out_layoutm.write('\t\tinclude "'+TAG_THISFOLDER+'pz/'+a+'.asm"\n')
