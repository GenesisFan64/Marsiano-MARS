...
out_head.write('.vert:\t\tbinclude "data/maps/mars/mcity/mdl/'+object_name+'/vert.bin"\n')
out_head.write('.face:\t\tbinclude "data/maps/mars/mcity/mdl/'+object_name+'/face.bin"\n')
out_head.write('.vrtx:\t\tbinclude "data/maps/mars/mcity/mdl/'+object_name+'/vrtx.bin"\n')
out_head.write('.mtrl:\t\tinclude "data/maps/mars/mcity/mdl/'+object_name+'/mtrl.asm"\n')
